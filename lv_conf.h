...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'P'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
...
/* Garbage Collector settingsLV_MEM_CUSTOM_REALLOC
...
#define LV_FONT_MONTSERRAT_12    1//osm
#define LV_FONT_MONTSERRAT_14    1//osm
